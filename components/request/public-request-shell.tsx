      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-md flex-col px-4 py-5">
        <header className="mb-4 pt-3">
          ...
          <div className="mt-5 grid grid-cols-3 gap-1.5 text-center text-[10px] uppercase tracking-[0.14em] text-champagne-100/80">
            <span className="rounded-md border border-champagne-700/35 bg-ink-900/45 px-2 py-2 backdrop-blur">Choose</span>
            <span className="rounded-md border border-champagne-700/35 bg-ink-900/45 px-2 py-2 backdrop-blur">Send</span>
            <span className="rounded-md border border-champagne-700/35 bg-ink-900/45 px-2 py-2 backdrop-blur">Confirm</span>
          </div>
        </header>
        {children}
      </div>
